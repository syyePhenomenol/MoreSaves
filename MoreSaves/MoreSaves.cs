...
namespace MoreSaves
{
    ...
    public class MoreSaves : Mod,IGlobalSettings<GlobalSettings>,ICustomMenuMod
    {
        ...
        public static Dictionary<int, string> SaveSlotNames = new Dictionary<int, string>();
        ...
        public void OnLoadGlobal(GlobalSettings s) => MoreSaves.settings = s;
        public GlobalSettings OnSaveGlobal() => MoreSaves.settings;
